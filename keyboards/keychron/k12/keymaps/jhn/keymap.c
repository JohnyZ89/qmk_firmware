...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_FN1] = LAYOUT_60_ansi(
        ...
        KC_BTPAIR, KC_BTPROF0, KC_BTPROF1, KC_BTPROF2, KC_BTRST, _______, _______, _______, KC_APP,  KC_SCRL, KC_INS,  KC_PGUP, KC_HOME, _______,
    ...
    [MAC_BASE] = LAYOUT_60_ansi(
        ...
        KC_LCTL, KC_LGUI, KC_LALT,                            KC_SPC,                             KC_LEFT, KC_DOWN, KC_RGHT, MO(MAC_FN1)
    ),
    /*
     * ┌───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───────┐
    ...
    [FN2] = LAYOUT_60_ansi(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, RGB_SAI, _______, _______, _______,          _______,
        _______,          _______, _______, _______, _______, _______, _______, RGB_HUD, RGB_SAD, RGB_HUI, _______,          _______,
        _______, _______, _______,                            _______,                            _______, _______, _______, _______
    ),
    /*
     * ┌───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───────┐
